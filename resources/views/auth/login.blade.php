                        ...
                        <div class="row g-0">
                            <div class="col-lg-7">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        <h4 class="mt-1 mb-5 pb-1">Welcome to, <span
                            ...
                            <div class="col-lg-5 d-flex align-items-center"
                                ...
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4 text-center">
                                    <h4 class="mb-4">Hello Mitra</h4>
                                    <p class="small">Enter your personal detail and start journey with us</p>
                                    <a href="{{ url('register') }}" class="btn btn-outline-light form-control p-3 mt-3"
